...
EOS_OUTPUT_DIR="/eos/user/h/hsiaoche/Signal/CstarToGJ_M1000_f1p0_13TeV_NANOAOD/CstarToGJ_M1000_f1p0_13TeV_NANOAOD_jobs"

eos mkdir -p ${EOS_OUTPUT_DIR}

# Fragment name
FRAGMENT_NAME="Configuration/GenProduction/python/CstarToGJ_M1000_f1p0_13TeV_pythia8_cfi"

# File names 
GENSIM_FILE="CstarToGJ_M1000_f1p0_13TeV_GENSIM_${TAG}.root"
DIGI2RAWHLT_PATH_FILE="CstarToGJ_M1000_f1p0_13TeV_DIGI2RAWHLT_${TAG}.root"
RECO_FILE="CstarToGJ_M1000_f1p0_13TeV_RECO_${TAG}.root"
MINIAOD_FILE="CstarToGJ_M1000_f1p0_13TeV_MINIAOD_${TAG}.root"
NANOAOD_FILE="CstarToGJ_M1000_f1p0_13TeV_NANOAOD_${TAG}.root"
...
# 3. Return to the scratch directory to avoid writing temporary files to AFS
