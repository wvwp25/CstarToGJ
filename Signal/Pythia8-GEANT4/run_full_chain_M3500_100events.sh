...
# Output: CstarToGJ_M3500_f0p1_13TeV_MINIAOD_1000events.root is written to /eos/user/h/hsiaoche/Signal/CstarToGJ_M3500_f0p1_13TeV_NANOAOD
#-----------------------------------------------------------------------------------------
...
# Fragment name
FRAGMENT_NAME="Configuration/GenProduction/python/CstarToGJ_M3500_f0p1_13TeV_pythia8_cfi"

# File names 
GENSIM_FILE="CstarToGJ_M3500_f0p1_13TeV_GENSIM_${TAG}.root"
DIGI2RAWHLT_PATH_FILE="CstarToGJ_M3500_f0p1_13TeV_DIGI2RAWHLT_${TAG}.root"
RECO_FILE="CstarToGJ_M3500_f0p1_13TeV_RECO_${TAG}.root"
MINIAOD_FILE="CstarToGJ_M3500_f0p1_13TeV_MINIAOD_${TAG}.root"
NANOAOD_FILE="CstarToGJ_M3500_f0p1_13TeV_NANOAOD_${TAG}.root"
