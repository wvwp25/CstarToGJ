...
usage() {
  cat <<'USAGE'
Usage:
  ./run_CstarToGJ_impacts_official_ranged.sh [options]
...
Examples:
  ./run_CstarToGJ_impacts_official_ranged.sh -f f1p0
  ./run_CstarToGJ_impacts_official_ranged.sh -f f0p5 --parallel 12 --r-min 0 --r-max 50
  ./run_CstarToGJ_impacts_official_ranged.sh -f f0p1 --mass-list "1000 1200 1400" --r-min -2 --r-max 10
  ./run_CstarToGJ_impacts_official_ranged.sh -f all
  ./run_CstarToGJ_impacts_official_ranged.sh -f 'f*'
